...
var editar = (id_empleado) => {
var uno = new Empleado_model(id_empleado,"", "", "", "", "", "", "uno");
uno.uno();
};

var eliminar=(id_empleado)=>{
  var eliminar = new Empleado_model(id_empleado, "", "", "", "", "", "", "eliminar");
  eliminar.eliminar();
}
...
var cedula_repetida = () => {
  var cedula = $("#cedula").val();
  var empleado = new Empleado_model(
    "",
    cedula,
    "",
    "",
